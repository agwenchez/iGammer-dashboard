      ...
      <TableRow>
        ...
        {headCells.map((headCell) => (
          <TableCell
            key={headCell.id}
            align={'left'}
            style={ headCell.id === 'name' ? { paddingLeft: '3em', fontWeight:'bold', fontSize: '1em'} : { fontWeight:'bold', fontSize: '1em'}}
  ...
  return (
    ...
    >
      {numSelected > 0 ? (
        ...
        id="tableTitle"
        component="div"
        style={{ borderBottom:'.5px solid gray', paddingBlock: '1.2em'}}
      >
        <input className={styles.searchbar} type="text" name="search" id="search" placeholder='Search' />
        Nutrition
      </Typography>
      )}
      {numSelected > 0 ? (
...
export default function EnhancedTable() {
  ...
  //     const newSelected = tableBody.map((n) => n.name);
  ...
  return (
    <div style={{ boxShadow: '1px 1px 10px rgba(0, 0, 0, 0.26)', borderRadius:'1em'}}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        <BsThreeDots className={styles.action_icon} size={'2.4em'} />
                        {/* <AiTwotoneDelete className={styles.delete_icon} size={'1.2em'}/> */}
                      </TableCell>
                    </TableRow>
                  );
                })}
