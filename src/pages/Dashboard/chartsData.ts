...
export const apexMixedCharts = {
  series: [
    ...
    },
    {
      name: "Profits",
      type: "area",
      data: [440000, 550000, 410000, 670000, 220000, 430000, 210000, 410000, 560000, 270000, 430000],
    },
    {
      name: "Refunded products",
      type: "line",
      data: [300000, 250000, 360000, 300000, 450000, 350000, 640000, 520000, 590000, 360000, 390000],
    },
  ],
  options: {
    chart: {
